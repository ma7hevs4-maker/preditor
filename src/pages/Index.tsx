...
const Index = () => {
  ...
  // Equipes adicionais baseado no backlog INICIAL informado vs meta
  const TARGET_BT = 70;
  const TARGET_MT = 10;
  
  // Calcula gap TOTAL do backlog inicial em relação às metas (usa valores informados pelo usuário)
