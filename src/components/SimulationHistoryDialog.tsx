...
import { History, Trash2, Calendar, Clock, Cloud, CloudOff, Play, Edit3 } from "lucide-react";
...
export const SimulationHistoryDialog = ({
  ...
  const handleSaveEdit = async (entry: SimulationHistoryEntry, updatedResults: SimulationRow[]) => {
    try {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Carregue ou edite simulações salvas.
            </DialogDescription>
          </DialogHeader>
